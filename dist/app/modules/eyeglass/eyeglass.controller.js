...
const createdonation = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const data = req.body;
    const result = yield donation_service_1.donationService.createdonation(
      data
    );
...
const getAlldonation = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(
      req.query,
      donation_constants_1.donationSearchableFields
    );
    const paginationOptions = (0, pick_1.default)(
      req.query,
      pagination_1.paginationFields
    );
    const result = yield donation_service_1.donationService.getAlldonation(
      filters,
      paginationOptions
    );
    (0, sendResponse_1.default)(res, {
...
const getSingledonation = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield donation_service_1.donationService.getSingledonation(
      id
    );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
...
const updatedonation = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const updateData = req.body;
    const result = yield donation_service_1.donationService.updatedonation(
      id,
      updateData
    );
    (0, sendResponse_1.default)(res, {
...
const deletedonation = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
